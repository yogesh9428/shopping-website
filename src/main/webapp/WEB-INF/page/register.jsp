                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <form:input type="text" placeholder="Enter First Name..." class="form-control" path="firstName" />
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <form:input type="text" placeholder="Enter Email ID..." class="form-control" path="users.emailId" />
                                <form:errors path="users.emailId"></form:errors>
                            </div>
                            <div class="col-sm-6 form-group">
                                <form:label path="customerPhone">Phone Number</form:label>
                                <form:input type="text" placeholder="Enter Phone Number..." class="form-control" path="customerPhone" />
                        ...
                        <div class="form-group">
                            ...
                            <form:textarea placeholder="Enter Shipping Address..." class="form-control" path="shippingAddress.address"></form:textarea>
                        </div>

                        <div class="row">
                            <div class="col-sm-6 form-group">
                                <form:label path="shippingAddress.city">City</form:label>
                                <form:input type="text" placeholder="Enter Current City..." class="form-control" path="shippingAddress.city" />
                            </div>
                            <div class="col-sm-6 form-group">
                                <form:label path="shippingAddress.state">State</form:label>
                                <form:input type="text" placeholder="Enter your State..." class="form-control" path="shippingAddress.state" />
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <form:input type="text" placeholder="Enter your Country..." class="form-control" path="shippingAddress.country" />
                            </div>
                            <div class="col-sm-6 form-group">
                                <form:label path="shippingAddress.zipcode">Zipcode</form:label>
                                <form:input type="text" placeholder="Enter Zipcode..." class="form-control" path="shippingAddress.zipcode" />
                        ...
                        <div class="form-group">
                            ...
                            <form:textarea placeholder="Enter Billing Address..." class="form-control" path="billingAddress.address"></form:textarea>
                        </div>

                        <div class="row">
                            <div class="col-sm-6 form-group">
                                <form:label path="billingAddress.city">City</form:label>
                                <form:input type="text" placeholder="Enter your City..." class="form-control" path="billingAddress.city" />
                            </div>
                            <div class="col-sm-6 form-group">
                                <form:label path="billingAddress.state">State</form:label>
                                <form:input type="text" placeholder="Enter your State..." class="form-control" path="billingAddress.state" />
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <form:input type="text" placeholder="Enter your Country..." class="form-control" path="billingAddress.country" />
                            </div>
                            <div class="col-sm-6 form-group">
                                <form:label path="billingAddress.zipcode">Zipcode</form:label>
                                <form:input type="text" placeholder="Enter Zipcode..." class="form-control" path="billingAddress.zipcode" />
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <form:input type="password" placeholder="********" class="form-control" path="users.password" id="pass" />
                            </div>
                            <div class="col-sm-6 form-group">
