        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1><strong>ShopIeasy</strong> Contact Form</h1>
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom contact-form">
                        ...
                        <form:form role="form" method="post" action="${url}" commandName="contact">
                            ...
                            <button style="float: right;" type="button" class="btn" onclick="window.location.href='<c:url value='/index1' />'">Back to Home</button>
                        </form:form>
                    </div>
                </div>
            </div>
