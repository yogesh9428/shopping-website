...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/resource/css/aboutus.css' />">
...
<div class="row" style="margin-top: 4px; margin-bottom: 19px;">
    <div class="col-sm-4" style="margin-top: 0px;">
        <div class="container-fluid bg-1 text-center">
            <h3>Who Am I?</h3>
            <img src="<c:url value='/resource/images/aboutImage.png' />" class="img-circle" alt="About Us" width="350" height="350">
    ...
    <div class="container-fluid bg-2 text-center">
        <h3>What Am I?</h3>
        <div id="para">
            <p>ShopIeasy's vision is to create India's most reliable and frictionless commerce ecosystem that creates life-changing experiences for buyers and sellers.</p>
        </div>
        <div id="para">
