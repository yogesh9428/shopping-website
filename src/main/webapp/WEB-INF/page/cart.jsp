...
<body>
    ...
    <div class="container" style="width: 1145px; margin-top: 20px; margin-bottom: 180px;">
        <div ng-app="myapp" ng-controller="myController" style="margin-bottom: 30px">
            <!-- Initialize the cart with cartId -->
            <div ng-init="getCart(${cartId})">
                <br> List of Products Purchased
                <div>
                    <!-- Clear Cart Button -->
                    <a class="btn btn-danger pull-left" ng-click="clearCart()" style="margin-top: 15px; margin-left: 20px">
                ...
                <div>
                    ...
                    <a href="${url1}" class="btn btn-danger pull-left" style="margin-top: 15px; margin-left: 20px">
                        <span class="glyphicon glyphicon-shipping-cart"> </span>Check Out
                    </a>
                </div>
                <!-- Cart Table -->
                <table class="table table-hover" id="productList">
                    ...
                    <tbody>
                        ...
                        <tr ng-repeat="cart in carts.cartItem">
                            ...
                            <td><a href="#" class="btn btn-danger" ng-click="removeFromCart(cart.cartItemId)" style="margin-top: 0px;">
