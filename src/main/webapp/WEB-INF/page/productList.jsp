...
<body ng-app="myapp">
	<div class="container" id="productTable" style="width: 1145px; margin-bottom: 180px;">
		...
		<table class="table table-hover table-responsive" id="productList">
			<thead>
				<tr>
					<th>Screen-Shot</th>
					<th>Product Id</th>
					...
					<tr>
						<td style="width: 171px">
							<img src="<c:url value='/resource/images/products/${prod.productId}.jpg'/>"
								style="width: 100px; height: 90px;" alt="${prod.productName}" />
						</td>
						...
						<td ng-controller="myController">
							<a href="getProductById/${prod.productId}" class="btn btn-info" role="button">
								<span class="glyphicon glyphicon-info-sign"></span> View
							</a>

							<!-- View and Add to Cart for User -->
							...
							<security:authorize access="hasAnyRole('ROLE_ADMIN')">
								<a href="admin/product/editProduct/${prod.productId}" class="btn btn-success" style="margin-left: 5px">
									<span class="glyphicon glyphicon-edit"></span> Edit
								</a>
								<a href="admin/delete/${prod.productId}" class="btn btn-danger" style="margin-left: 5px">
