        ...
        <div class="container" style="width: 829px">
            ...
            <table class="table table-bordered" id="prod">
                <tbody>
                    <tr>
                        <td>Product Image</td>
                        <td><img src="<c:url value='/resource/images/products/${productObj.productId}.jpg'/>"
                            ...
                            <div ng-controller="myController">
                                <security:authorize access="hasRole('ROLE_USER')">
                                    <a href="#" ng-click="addToCart(${productObj.productId})"
                                       class="btn btn-info" style="margin-top: 0px; width: 150px; float: left; margin-right: 31px;">
                                ...
                                <a href="<c:url value='/getAllProducts' />" class="btn btn-info"
                                   ...
                                   <span class="glyphicon glyphicon-arrow-left"></span> Back to Products
                                </a>
                            </div>
                        </td>
                    </tr>
