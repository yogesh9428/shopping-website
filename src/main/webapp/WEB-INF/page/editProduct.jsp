                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <form:input type="text" placeholder="Enter ProductId.." class="form-control" path="productId" disabled="true" />
                            </div>
                            <div class="col-sm-6 form-group">
                        ...
                        <div class="form-group">
                            ...
                            <form:textarea type="text" placeholder="Enter Product Description.." class="form-control" path="productDescription" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                <form:input type="text" placeholder="Number of Products.." class="form-control" path="unitStock" />
                            </div>
                        </div>
